...
console.log(userSayHello()); // "Hello undefined" / (userSayHello is called without context)
console.log(typeof userSayHello.bind(user2)); // function / 
console.log(userSayHello.bind(user2)()); // " Hello Arya" / 
console.log(user3.sayHello()); //  / it means user3 object does not a sayHello method defined
