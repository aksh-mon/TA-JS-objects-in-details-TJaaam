...
class classUser {
  ...
  console.log(classUser1.getProjects()); // Output: 3
  console.log(classUser2.changeName('Rama')); // Output: Alice
  console.log(classUser1.incrementProject()); // Output: 4
  console.log(classUser2.decrementProject()); // Output: 4
